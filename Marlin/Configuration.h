...
#define STRING_CONFIG_H_AUTHOR "(Raphael Gatti, Graber)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 194.10
  #define DEFAULT_bedKi 15.29
  #define DEFAULT_bedKd 616.13
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1500, 837 }
